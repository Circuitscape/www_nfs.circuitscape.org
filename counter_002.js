...
//			SiteMeter.onPageLoad();
    ...
    newIFrame.frameBorder=0;
		newIFrame.width = 0;
		newIFrame.height = 0;
		newIFrame.src = "http://dg.specificclick.net/?u=" + encodeURIComponent(document.location) + "&r=" + SiteMeter.getReferral2() + "&site=" + SiteMeter.CodeName;
...
SiteMeter.init('s26bhmcraecircuitscapenew', 's26.sitemeter.com', '');

var g_sLastCodeName = 's26bhmcraecircuitscapenew';

var siteID = "s26bhmcraecircuitscapenew";

var detectClicks = false;

var flashVer = "unknown";
var jsVersion = "unknown";
var frameWidth = 0;
var frameHeight = 0;
var dc = true;

document.write( '<script type="text/javascript" src="http://js.sitemeter.com/js/splittrack.js"></script>' );
// ]]>
