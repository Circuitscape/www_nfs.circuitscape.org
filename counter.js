...
var SiteMeter =
{
	init:function()
	{
		SiteMeter.CodeName = "s15bhmcraesoft";
		SiteMeter.ServerName = "s15.sitemeter.com";		
		SiteMeter.SecurityCode = "";	
		SiteMeter.IP = "128.111.220.142";	
		SiteMeter.trackingImage = new Image();
		
		if (typeof(g_sLastCodeName) != 'undefined')
			if (g_sLastCodeName == "s15bhmcraesoft")
				return;
...
var g_sLastCodeName = "s15bhmcraesoft";
// ]]>
